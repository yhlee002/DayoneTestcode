...
public class StudentScoreServiceMockTest {
  ...
  public void firstSaveScoreMockTest() {
    ...
    studentScoreService.saveScore(
        givenStudentName, givenExam, givenKorScore, givenEngScore, givenMathScore);
  }
  ...
  public void saveScoreMockTest() {
    ...
    Assertions.assertEquals(
        expectedStudentScore.getStudentName(), capturedStudentScore.getStudentName());
    ...
    Assertions.assertEquals(
        expectedStudentScore.getEnglishScore(), capturedStudentScore.getEnglishScore());
    Assertions.assertEquals(
        expectedStudentScore.getMathScore(), capturedStudentScore.getMathScore());
    ...
    Assertions.assertEquals(
        expectedStudentPass.getStudentName(), capturedStudentPass.getStudentName());
  ...
  public void saveScoreMockTest2() {
    ...
    Assertions.assertEquals(
        expectedStudentFail.getStudentName(), capturedStudentFail.getStudentName());
  ...
  public void getPassStudentListTest() { // 테스트 메서드명: 메서드명 + 'Test'가 관례
    ...
    StudentPass expectStudent1 = StudentPassFixture.create("jyujyu", givenExam);
    StudentPass expectStudent2 = StudentPassFixture.create("test", givenExam);
    StudentPass notExpectStudent3 = StudentPassFixture.create("imnot", "secondexam");
  ...
  public void getFailStudentListTest() {
    ...
    StudentFail expectStudent1 = StudentFailFixture.create("test", givenExam);
    StudentFail expectStudent2 = StudentFailFixture.create("imnot", givenExam);
    StudentFail notExpectStudent3 = StudentFailFixture.create("jyujyu", "secondexam");
